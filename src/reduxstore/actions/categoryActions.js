...
export const getCategories = () => (dispatch, getState) => {
    ...
    axios
        .get(`${config.stagingBaseUrl}/categories?per_page=100`, userTokenConfig(getState))
        .then((res) =>
            dispatch({
...
export const getPaginatedCategories = (itemsPerPage, currentPage, success, failed) => (dispatch, getState) => {
    ...
    axios
        .get(
            `${config.stagingBaseUrl}/categories?per_page=${itemsPerPage}&page=${currentPage}`,
...
export const addCategory = (newCategory) => (dispatch, getState) => {
    ...
    axios
        .post(`${config.stagingBaseUrl}/categories`, body, userTokenConfig(getState))
        .then((res) =>
            dispatch({
...
export const updateCategory = (catInfo, success, failed) => (dispatch, getState) => {
    ...
    axios
        .patch(`${config.stagingBaseUrl}/categories/${catInfo.id}`, body, userTokenConfig(getState))
        .then((res) => {
