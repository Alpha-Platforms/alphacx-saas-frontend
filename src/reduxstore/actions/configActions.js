...
export const getConfigs = (success) => (dispatch, getState) => {
    ...
    axios
        .get(`${config.stagingBaseUrl}/settings/config`, userTokenConfig(getState))
        .then((res) => {
            dispatch({
...
export const updateEmailConfig = (emailConfig, successCallback, failureCallback) => (dispatch, getState) => {
    ...
    axios
        .patch(`${config.stagingBaseUrl}/settings/ticket-email-template`, body, userTokenConfig(getState))
        .then((res) => {
...
export const updateTwitterConfig = (newTwitterConfig, success, failed) => (dispatch, getState) => {
    ...
    axios
        .patch(`${config.stagingBaseUrl}/settings/twitter-config`, JSON.stringify(body), userTokenConfig(getState))
        .then((res) => {
