...
export function ExportDropdown({ handlePDFExport, handleCSVExport, addLeftMargin, exportAll }) {
    const [exportMenuOpen, setExportMenuOpen] = useState(false);

    return (
        <Dropdown id="export-dropdown-main" className={`ticket-export-dropdown ${addLeftMargin ? 'mg-lft' : ''}`}>
            <DropdownToggle onClick={() => setExportMenuOpen(!exportMenuOpen)}>
                <SaveAlt />
            </DropdownToggle>
            <DropdownMenu
                className="export-dd-menu"
                style={{ display: exportMenuOpen ? 'block' : 'none' }}
                onMouseLeave={() => setExportMenuOpen(false)}
            >
                <MenuItem className="export-dd-child">
                    Export Selected Tickets
                    <MenuItem onClick={() => handlePDFExport('selected')}>As PDF</MenuItem>
                    <MenuItem onClick={() => handleCSVExport('selected')}>AS CSV</MenuItem>
                </MenuItem>
                {exportAll && (
                    <MenuItem className="export-dd-child">
                        Export All Ticket
                        <MenuItem onClick={() => handlePDFExport('all')}>As PDF</MenuItem>
                        <MenuItem onClick={() => handleCSVExport('all')}>AS CSV</MenuItem>
                    </MenuItem>
                )}
            </DropdownMenu>
        </Dropdown>
...
function TicketList({ isTicketsLoaded, tickets, meta, getPaginatedTickets, isUserAuthenticated, user }) {
    ...
    return (
        <div>
                ...
                <Dropdown.Submenu position="right">
                  ...
                  <Dropdown.Item onClick={() => handleCSVExport('all')}>
                    ...
                    <div id="delete-btn-wrapper" className="delete-btn-wrapper d-none">
                        <div>
                            <button
                                onClick={openTicketDeleteModal}
                                id="ticket-delete-btn"
                                className="btn"
                                type="button"
                            >
                        ...
                        <div>
                            <span>
                                <span id="selected-row-count">0</span> ticket(s) selected
                            </span>
                        </div>
                    </div>
                </div>
            ...
            />
            <div>
                <div id="ticket-delete-confirm-modal" className="react-responsive-modal-root d-none" data-testid="root">
                    <div
                        className="react-responsive-modal-overlay"
                        data-testid="overlay"
                        aria-hidden="true"
                        style={{ animation: '300ms ease 0s 1 normal none running react-responsive-modal-overlay-in' }}
                    />
                    <div
                        className="react-responsive-modal-container react-responsive-modal-containerCenter"
                        onClick={closeTicketDeleteModal}
                    ...
                    >
                        <div
                            ...
                            data-testid="modal"
                            tabIndex="-1"
                            style={{ animation: '300ms ease 0s 1 normal none running react-responsive-modal-modal-in' }}
                            onClick={(e) => e.stopPropagation()}
                        >
                            <div className="p-5 w-100">
                                <h6 className="mb-5">Are you sure you want to delete?</h6>
                            ...
                            <button className="react-responsive-modal-closeButton" data-testid="close-button">
            ...
            >
                <div className="p-5 w-100">
                    ...
                    <div className="d-flex justify-content-center">
                        ...
                        <button type="button" className="btn btn-sm ms-2 f-12 bg-custom px-4" onClick={(e) => {}}>
                            Yes
                        </button>
                    </div>
                </div>
