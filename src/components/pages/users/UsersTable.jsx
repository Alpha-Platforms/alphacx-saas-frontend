...
function UsersTable({ isTicketsLoaded, tickets }) {
    ...
    return (
        <div>
            ...
            <div className="m-4">
                ...
                <div className="d-flex justify-content-between flex-wrap bg-light rounded-top-big flex-md-nowrap align-items-center p-4 px-3">
                    <div />
                            ...
                            <MaterialTable
                                ...
                                columns={[
                                    ...
                                    },
                                    {
                                        ...
                                        field: 'state',
                                        render: (rowData) => (
                                            <div className="ticket-state yellow">
                                                <Link
                                                    to="#"
                                                    className="btn btn-sm"
                                                    style={{ color: rowData.state.foreground_color }}
                                                >
                                                    {rowData.state.status}
                                                </Link>
                                            </div>
                                        ),
                                    },
                                    {
                                        ...
                                        field: 'status',
                                        render: (rowData) => (
                                            <select name="ticket-status-select" id="ticket-status-select">
