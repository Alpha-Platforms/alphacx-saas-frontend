...
function OrganisationList() {
    ...
    return (
        <>
            <div>
                <div className="d-flex justify-content-between flex-wrap bg-light rounded-top-04 flex-md-nowrap align-items-center p-4">
                    <div>
                    ...
                    <div className="btn-toolbar mb-md-0">
                        ...
                        <button type="button" className="btn btn-sm btn-outline-secondary px-md-3 mx-md-3">
                            <ImportSvg />
                            &nbsp;Export
                        </button>
                                    ...
                                    <tr key={idx}>
                                        ...
                                        <td>
                                            <div className="d-flex user-initials-sm">
                                                <div className={`user-initials ${theme || 'red'}`}>
                                                    {getUserInitials(company)}
                                                </div>
