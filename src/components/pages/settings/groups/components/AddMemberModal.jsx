...
function AddMemberModal({ addMemberModalShow, setAddMemberModalShow, groups }) {
    // create user modal
    return (
        <Modal
                    ...
                    <form action="">
                        <div className="form-group mt-3">
                            ...
                            <div id="searchBox" className="row hider p-3 justify-content-between border mx-0">
                                <div className="col-9">
                                    <div className="tab-content" id="nav-tabContent">
                                        ...
                                        >
                                            <ul className="list-unstyled">
                                                <li>
                                                    <p role="button" className="user-entity" data-group="groupId">
                                                        Head Office
                                                    </p>
                                                </li>
                                                <li>
                                ...
                                <div className="col-3 border-start">
                                    <div className="list-group group-entity-filter" id="list-tab" role="tablist">
                                        <button
                                            className="btn btn-sm mb-1 active"
                                            id="customerUsers-list"
                                            data-bs-toggle="list"
                                            href="#customerUsers"
                                            role="tab"
                                            aria-controls="customerUsers"
                                        >
                                            Users
                                        </button>
                                        ...
                                        <button
                                            ...
                                            id="customerRoles-list"
                                            data-bs-toggle="list"
                                            href="#customerRoles"
                                            role="tab"
                                            aria-controls="customerRoles"
                                        >
                                            Roles
                                        </button>
                            ...
                            <div className="d-flex justify-content-end">
                                <a href="group-member-list.html" className="btn btn-sm bg-at-blue px-4 mt-3">
                                    Add Member
                                </a>
                            </div>
                        </div>
