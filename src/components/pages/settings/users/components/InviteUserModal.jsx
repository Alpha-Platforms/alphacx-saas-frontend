...
function InviteUserModal({ inviteModalShow, setInviteModalShow }) {
    return (
        <Modal
            ...
            <Modal.Body>
                <div className="modal-body w-100" id="new-modal">
                        ...
                        <div className="row gx-2">
                            <div className="col-md-4">
                                <div className="form-group mt-4">
                                    <label className="f-14 mb-1" htmlFor="#fullName">
                                        First Name
                                    </label>
                            ...
                            <div className="col-md-4">
                                <div className="form-group mt-4">
                                    <label className="f-14 mb-1" htmlFor="#role">
                                        Last Name
                                    </label>
                            ...
                            <div className="col-md-4">
                                <div className="form-group mt-4">
                                    <label className="f-14 mb-1" htmlFor="#email">
                                        Email Address
                                    </label>
                    ...
                    <div className="d-flex flex-row justify-content-between px-3">
                        <button
                            type="button"
                            className="btn bg-outline-custom btn-sm float-start w-25 mt-4 mb-2 text-center btn-add"
                        >
                            Add more&nbsp;
                            <AddButtonSvg />
                        </button>
