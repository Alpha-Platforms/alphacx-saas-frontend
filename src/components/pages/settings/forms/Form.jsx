                ...
                <div id="settings">
                    ...
                    >
                        <div className="d-flex justify-content-between align-items-center">
                            ...
                            <span>
                                <Link to="#" class="btn bg-at-blue-light btn-sm rounded-2 px-5">
                                    Preview
                                </Link>
                            </span>
                        </div>
                        <div className="bg-sky-blue border-sky-blue p-4 mt-5 rounded-3">
                            <label htmlFor="welcome-message" className="text-black fs-6 fw-bold d-block">
                                Form Description
                            </label>
                            <input
                                type="text"
                        ...
                        {isFieldEmpty ? (
                            ...
                            <div className="text-center pt-5 pb-5 mt-5 mb-5">
                                ...
                                <div className="text-start mt-2">
                                    <button
                                        className="btn btn-link text-decoration-none text-at-blue-light"
                                        onClick={() => setAddFieldModalShow(true)}
                                    >
                                        + Add New Field
                                    </button>
                                </div>
                        ...
                        <div className="bg-sky-blue border-sky-blue p-4 mt-5 rounded-3 mb-5">
                            <label htmlFor="thankyou-msg" className="text-black fs-6 fw-bold d-block">
                                Success Message
                            </label>
                            <input
                                type="text"
