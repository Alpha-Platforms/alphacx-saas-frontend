...
function AddFieldModal({ addFieldModalShow, setAddFieldModalShow }) {
    return (
        <Modal
            ...
            <Modal.Body>
                ...
                <form action="">
                    <div className="form-group mt-3">
                        <label className="f-12" htmlFor="fieldName">
                            Field Name
                        </label>
                        <input type="text" name="field-name" className="form-control form-control-sm" id="fieldName" />
                    </div>
                    <div className="form-group mt-3">
                        <label className="f-12 form-select-label" htmlFor="fieldType">
                            Field Type
                        </label>
                        <select name="field-type" className="form-select form-select-sm f-12 py-2" id="fieldType">
                    ...
                    <div id="allOptionsContainer">
                        <div className="form-group mt-3 d-none" id="fieldOptionsWrapper">
                            ...
                            <button
                                type="button"
                                className="no-focus btn btn-link f-12 text-decoration-none text-at-blue-light"
                            >
                                + Add option
                            </button>
                        </div>
                    ...
                    <div className="form-group mt-3">
                        <label className="f-12" htmlFor="makeOptional">
                            Make field optional
                        </label>
                    ...
                    <div className="text-end">
                        ...
                        <button type="button" className="btn btn-custom btn-sm w-25 d-inline-block">
                            Add Field
                        </button>
                    </div>
                </form>
