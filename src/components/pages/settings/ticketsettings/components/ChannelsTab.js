...
const ChannelsTab = ({channels, isChannelsLoaded, getChannels, updateChannel, addChannel}) => {
        ...
        <div className="my-3 mt-4">
            <Row className="">
                <Col md={9} sm={12} lg={8} className="mb-4 mt-4">
                    <div className="">
                        <label htmlFor="ticket-channels" className="form-label d-inline-block">Channels:</label>
                    </div>
                    <div className="text-center ">
                        <div className="fieldsWrapper pb-3" id="ticketFieldWrapper">

                            {channels && channels.map(({name, status, id}, idx) => <div key={idx} className="fieldParent d-flex my-2">
                                {/* <button
                                    type="button"
