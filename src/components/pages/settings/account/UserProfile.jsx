...
function AccountSettings() {
    ...
    const handleAvatar = (e) => {
        ...
        const avatarImage = URL.createObjectURL(files[0]);
        console.clear();
                                    ...
                                    {personalInformation?.avatar?.blob ||
                                        (personalInformation.avatar !== {} && (
                                            <img
                                                ...
                                                src={personalInformation?.avatar?.blob || personalInformation?.avatar}
                                                alt=""
                                            />
                                        ))}
                                </div>
            ...
            */}
                        <div className="mb-5">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                            />
                            <button className="btn btn-sm bg-at-blue-light px-3 py-1 mt-3">Change Password</button>
                        </div>
                        {/*
            <!-- * Notifications -->
            */}
