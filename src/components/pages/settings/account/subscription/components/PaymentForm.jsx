    ...
    return (
        <div className="payment-form">
            <div className="mt-3 paymnt-detl">
                ...
                <div className="mb-3">
                    <label htmlFor="p-bill-add" className="form-label">
                        Billing Address
                    </label>
            ...
            <div className="paymnt-mthd">
                ...
                <div className="form-check">
                    <input className="form-check-input" type="radio" name="card-paymnt" id="card-paymnt" />
                    <label className="form-check-label" htmlFor="card-paymnt">
                        <form autoComplete="off">
                            ...
                            <div className="mb-3">
                                <label htmlFor="p-card-no" className="form-label">
                                    Card Number
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-3">
                                <label htmlFor="p-card-name" className="form-label">
                                    Card Name
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="row">
                                <div className="mb-3 col-6">
                                    <label htmlFor="p-exp-date" className="form-label">
                                        Expiration Date
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="mb-3 col-6">
                                    <label htmlFor="p-cvv" className="form-label">
                                        CVV
                                    </label>
                                    <input
                                        type="text"
                            ...
                            <div className="card-paymnt-btn">
                                <button type="submit" className="btn bg-at-blue-light">
                                    Confirm Payment
                                </button>
                ...
                <div className="form-check">
                    <input className="form-check-input" type="radio" name="bank-transfer" id="bank-transfer" />
