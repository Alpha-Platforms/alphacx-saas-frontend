...
export default function SettingsHome() {
    ...
    return (
        ...
        <div className="form-group w-25 mb-4 rounded-pill">
            <input type="search" className="form-control magnifying-glass py-2" placeholder="Search Settings" />
        </div>

        <div className="flex-wrap d-flex align-items-start gap-3" style={{ flexBasis: '32%' }}>
        ...
        <Link to="/settings/users" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Assign user type, persmissions and other
                        details</p>
                </div>
            </div>
        </Link>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Automate notifications, responses and
                        durations</p>
                </div>
            </div>
        </a>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Access your profile and account
                        subscriptions</p>
                </div>
            </div>
        </a>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Description here</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Configure inbound and outbound email
                        settings for your organization</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Capture specific information for customers,
                        tickets and users</p>
                </div>
            </div>
        </a>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Create custom forms for tickets and
                        customers</p>
                </div>
            </div>
        </a>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Define structures and levels within your
                        organization</p>
                </div>
            </div>
        </a>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Set different locations for your
                        organization</p>
                </div>
            </div>
        </a>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Define access levels and permission for
                        user types</p>
                </div>
            </div>
        </a>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Generate analytical reports</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Organize users in your organization</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Assign notifications roles to users</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Integrate Active Directory/LDAP</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Learn how to use AlphaCX, fix a problem and
                        get answers to your questions</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Import existing database into your
                        organization</p>
                </div>
            </div>
        </a>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Create ticket types, organize and
                        prioritize tickets</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Record of events and changes</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Integrate third party apps such as Facebook
                        and Twitter</p>
                </div>
            </div>
        </a>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Change outlook of your organization</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Update your user profile</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">View subscription status</p>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="#" className="d-block cursor text-decoration-none">
            <div className="d-flex align-items-center p-md-4">
                ...
                <div className="ms-3">
                    ...
                    <p className="acx-fs-8 lh-1 mt-1 text-muted">Setup ratings for customer feedback</p>
                </div>
            </div>
        </a>
    </div>
