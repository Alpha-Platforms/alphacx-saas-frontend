    ...
    const tableColumns = [
        {
            ...
            render: (rowData) => (
                <span
                    ...
                    style={{ color: '#0a58ca' }}
                    onClick={() => history.push(`/settings/automation/${automationPolicies[rowData.tableData.id].id}`)}
                >
                    {rowData.name}
                </span>
            ),
            ...
            <Modal open={openDeleteActionModal} onClose={() => setOpenDeleteActionModal(false)} center>
                <div className="p-5 w-100">
                    ...
                    <div className="d-flex justify-content-center">
                        ...
                        <button className="btn ms-2 f-12 bg-custom px-4" onClick={deleteAutomation}>
                            Confirm
                        </button>
                    </div>
                </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                        <div className="w-50">
                            <p className="small mb-0">
                                Automation Policies help you setup and maintain targets for the duration within which
                                your teams respond and resolve tickets.
                            </p>
                            <p className="text-muted acx-fs-8">
