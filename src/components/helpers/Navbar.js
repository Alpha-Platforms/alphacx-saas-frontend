...
function Navbar({ navbarTitle }) {
    return (
        <div className="d-flex justify-content-between flex-wrap bg-white mb-1 flex-md-nowrap align-items-center border-bottom px-5 py-3">
            ...
            <div className="btn-toolbar mb-2 mb-md-0">
                ...
                >
                    <i className="bi-search" style={{ fontSize: '1.2rem' }} />
                </Link>
                &nbsp;
                ...
                <Link to="#" className="user-avatar">
                    <img src={ManImage} loading="lazy" alt="" className="image" />
                </Link>
            </div>
        </div>
    );
